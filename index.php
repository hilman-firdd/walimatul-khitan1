...
<head>
    ...
    <link rel="shortcut icon" href="https://risalahati.id/wp-content/uploads/2022/02/logo-icon.png">
    <link rel="canonical" href="https://risalahati.id">
    <meta name=author content="risalahati.id">
    <meta name=language content="Indonesia">
    <meta name=googlebot-news content="noindex">
    <meta name=googlebot content="noindex">
    <meta name=robots content="noindex">
    <meta name=description content="Walimatul Khitan Athallah Syathir Mumtaz Berlangsung acara pada hari Sabtu, 24 Desember 2022. Undangan khitan online by risalahati.id">
    <meta name=keywords content="risalahati,undangan,pernikahan,online,website,wedding,invitation">
    <meta name=twitter:card content="summary">
    <meta name=title content="Walimatul Khitan Athallah Syathir Mumtaz">
    ...
    <title>Walimatul Khitan Athallah Syathir Mumtaz</title>
...
<body>
    <nav class="navbar navbar-expand-lg fixed-bottom navbar-light bg-light" id="bot-menu">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="#couple"><svg width=1em height=1em viewBox="0 0 16 16" class="bi bi-heart-fill" fill="currentColor" xmlns="https://www.w3.org/2000/svg">
                    ...
                    </svg><span class="d-none d-lg-block"> Detail </span></a></li>
    ...
    <section style="background:url('img/Background Isi.webp') center center no-repeat; " class="cover" id="home">
        ...
        $new = str_replace(' ', '%20', $params[1]);
        $baso = $new;
        ?>
        <div class="title text-center text-white">
            <div data-aos="fade-up" data-aos-delay="200">
                <div style="margin-top:80px; color:#2e3f44;">
                    <h5>Walimatul Khitan</h5>
                    <p style="font-size: 24px;">Athallah Syathir Mumtaz</p>
                </div>
                <div class="d-flex justify-content-center" style="position:relative; top:-50px;">
                    <img src="img/brand.png"  style="height:280px;"><br>
                </div>
                <br>
                <p class="guest" style="font-size:20px; color:#0d0f1c!important; margin-top:-1.2rem; font-weight:400;">Kepada YTH.<br>
                    <?php if (urldecode($baso)) { ?>
                        <strong class="yth" style="font-size:20px; color:#0d0f1c!important; font-weight:700;"><?= urldecode($baso) ?></strong>
                    <?php } else { ?>
    ...
    <section style="background:url('img/Background Isi.webp') center center no-repeat;" class="curved page-holder bg-cover" id="particles-js">
        <div class="container">
            <header class="text-center text-white vh-100 d-flex flex-column align-items-center justify-content-center mb-5">
                ...
                <p style="font-size:15.5px; font-family: 'Noto Naskh Arabic', serif; color:#0a3d3e;">رَبِّ اجْعَلْنِي مُقِيمَ الصَّلاَةِ وَمِنْ ذُرِّيَّتِي رَبَّنَا وَتَقَبَّلْ دُعَاءِ</p>
                <p style="font-size:13.5px; color:#0a3d3e;">Ya Rabb-ku, jadikanlah aku dan anak cucuku orang-orang yang tetap mendirikan shalat, ya Tuhan kami, perkenankanlah doaku.</p>
            </header>
        </div>
    </section>
    ...
    <section class="couple" id="couple" style="background:url('img/Background Isi.webp') center center no-repeat;background-size: cover; margin-top:-4.5rem;">
        ...
        <div class="container" data-aos="fade-up">
            <i>Dengan memohon rahmat dan ridho Allah swt</i><br><br>
            <p>Kami bermaksud mengundang ikhwatu iman sekalian dalam acara Walimatul Khitan anak kami<br>
            <h3>Athallah Syathir Mumtaz</h3>
            <p>yang insya Allah akan diselenggarakan pada:</p><br>
            <div class="card information h-100" style="margin:0 auto; width:60%; border-radius:10px; box-shadow:2px 2px 10px rgb(252,211,223);">
                <div class="card-body">
                    <div class="row mt-4">
                        <div class="col date">
            ...
            <div class="py-3 w-50 text-center m-auto">
                <p>Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila Bapak/Ibu/Saudara/i berkenan hadir untuk memberikan doa terbaik untuk anak kami.</p>
            </div>
        </div>
        ...
        <div class="col-lg-7 mx-auto mb-5">
            ...
            <div data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="1000" class="col-lg-5 text-center couples">
                    <div class="row">
                        <div class="col-12 px-5">
                            <h2 style="font-size:1.7rem; font-family:dancing; letter-spacing: -1px;" class="my-3">Tendi Hardiansyah, S.Sos.</h2>
                        </div>
                    </div>
                </div>
                <div data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-delay="100" data-aos-duration="1000" class="col-lg-5 text-center couples  order-1">
                    <div class="row">
                        <div class="col-12 px-5">
                            <h2 style="font-size:1.7rem; font-family:dancing; letter-spacing: -1px;" class="my-3">Syifa Ula Robbani, S.Pd.</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-5">
                <h6>Cucu dari: </h6>
                <p>Bapak Rachmat & Ibu Rorok Surniasih</p>
                <p>Bapak Engkos Kosasih, S.Pd.I & Ibu Dede Maryati, S.Pd.I</p>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    ...
                    <div class="swiper mySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="img/galleri/1.JPG" alt="" width="320"></div>
                            <div class="swiper-slide"><img src="img/galleri/2.JPG" alt="" width="320"></div>
                            <div class="swiper-slide"><img src="img/galleri/3.JPG" alt="" width="320"></div>
                            <div class="swiper-slide"><img src="img/galleri/4.JPG" alt="" width="320"></div>
                        </div>
    ...
    <section id="countdown" class="pb-0" style="background:url('img/Background Isi.webp') center center no-repeat;background-size: cover;">
        <div class="container text-center mt-5">
            ...
            <div class="col-lg-8 mt-5 mx-auto">
                <div class="row timer-wrapper">
                    <div class="col-lg-3 col-6 text-center" data-aos="fade-right" data-aos-delay="100">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="timer mb-3"><span id="days">00</span></h4>
                    ...
                    <div class="col-lg-3 col-6 text-center" data-aos="fade-right" data-aos-delay="200">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="timer mb-3"><span id="hours">00</span></h4>
                    ...
                    <div class="col-lg-3 col-6 text-center" data-aos="fade-right" data-aos-delay="300">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="timer mb-3"><span id="minutes">00</span></h4>
                    ...
                    <div class="col-lg-3 col-6 text-center" data-aos="fade-right" data-aos-delay="400">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="timer mb-3"><span id="seconds">00</span></h4>
            ...
            <div class="col-lg-8 mx-auto">
                <br><br>
                <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&amp;dates=20230212T020000Z/20230212T050000Z&amp;text=Juliet+%26+Romeo+Wedding&amp;details=Juliet+%26+Romeo+Wedding+on+Sunday%2C+12+February+2023&amp;location=Jogja+Expo+Center+%7C+Jl.+Wonocatur%2C+Wonocatur%2C+Banguntapan%2C+Kec.+Banguntapan%2C+Bantul%2C+Yogyakarta" target="_blank" class="btn btn-secondary mt-2 mx-1" data-aos="fade-up" data-aos-delay="600">Google Calendar</a>
                <a href="https://calendar.yahoo.com/?v=60&amp;view=d&amp;type=20&amp;ST=20230212T020000Z&amp;ET=20230212T050000Z&amp;TITLE=Juliet%20%26%20Romeo%20Wedding&amp;DESC=Juliet%20%26%20Romeo%20Wedding%20on%20Sunday%2C%2012%20February%202023&amp;in_loc=Jogja%20Expo%20Center%20%7C%20Jl.%20Wonocatur%2C%20Wonocatur%2C%20Banguntapan%2C%20Kec.%20Banguntapan%2C%20Bantul%2C%20Yogyakarta" target="_blank" class="btn btn-secondary mt-2 mx-1" data-aos="fade-up" data-aos-delay="700">Yahoo Calendar</a>
                <br><br><br>
            </div>
        </div>
    </section>
    ...
    <section class="text-center pt-0" style="background:url('img/Background Isi.webp') center center no-repeat;background-size: cover;">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.716106685756!2d107.5814780147729!3d-6.92449999499685!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x267516508fd27017!2zNsKwNTUnMjguMiJTIDEwN8KwMzUnMDEuMiJF!5e0!3m2!1sen!2sid!4v1670311242835!5m2!1sen!2sid" width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <a target="_blank" href="https://maps.app.goo.gl/8uqFfM7n6XVRhDtq6?g_st=iw" class="btn btn-secondary mt-5 mx-1" data-aos="fade-up" data-aos-delay="500">Open Google Map</a>
        ...
        <section class="form-ucapan container" style="margin-top:-2rem">
            <form method="POST" id="form-doa">
                ...
                <div class="input pt2">
                    ...
                    <textarea class="form-control" id="doa" name="doa" placeholder="Ucapan dan Doa" rows="4"></textarea>
                    <button onClick="kirim()" type="button" id="btn-doa" class="mt-3 btn btn-secondary btn-sm">Sampaikan</button>
                </div>
            </form>
        </section>

        <div class="show-guest-book px-2">
                    ...
                    foreach ($query as $data) : ?>
                        <div class="col-md-12 mb-3">
                            <div class="media px-3 media-comment">
                                <img class="rounded-circle mr-3 d-none d-sm-block d-md-block d-lg-block" src="https://na.ui-avatars.com/api/?name=<?= $data['nama'] ?>&size=50&background=bf616b&color=ffffff" alt="Image Avatar">
                                <div class="media-body">
                                    <div class="mb-2">
                                        <h5 class="h6 mb-0 text-secondary"><?= $data['nama'] ?></h5>
                                        <!-- 31 October 2021 05:10 -->
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="col-md-12 pt-4">
                <div style="max-width:500px;margin:auto">
                    <div style="font-family:monserta; font-weight:bold;display:inline-block;margin-bottom:10px;font-size:1.1rem;">Protokol Kesehatan</div> <br>
                    ...
                    <table style="font-size:0.9rem;margin:auto">
                        <tbody>
                            <tr>
                                <td width=50%> <img src="img/Menggunakan Maser.png" alt="masker" style="max-width:75px"><br></td>
                                <td width=50%> <img src="img/Jaga jarak.png" alt="distance" style="max-width:75px"><br></td>
                            </tr>
                            <tr>
                                <td width=50%> <img src="img/Cuci Tangan.png" alt="salam" style="max-width:75px"><br></td>
                                <td width=50%> <img src="img/pakai handsanitizer.png" alt="wash" style="max-width:75px"><br></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <footer style="margin-top:-40px; margin-bottom:80px;">
        <button id="audio" class="audio">
            <span id="play"> &#9658; </span>
            <span id="pause"> &#10074;&#10074; </span>
        </button>
    <div style="height:50px;width:60px;position: absolute;bottom:0;z-index:-1;">
        <audio id="myAudio" autoplay loop>
            <source src="./music/omarr.mp3" type="audio/mpeg" />
        </audio>
    </div>
        <div class="container">
            <div class="col-md-12">
                <a href="https://risalahati.id" title="Undangan Pernikahan Online">
                    <img src="img/logo_brand.png"></a>
                <small>Website Undangan Online</small>
            </div>
        </div>
    </footer>
     
    <!--<div class="play-pause btn-play-pause" id="button-control"><img src=https://demo.datengdong.com/images/play-pause.svg alt="play pause" width=25px></div>-->
    <button type=button class="btn-donation" data-toggle="modal" data-target="#modalGift">
        <img src="https://cdn-icons-png.flaticon.com/512/3209/3209955.png" alt="donation" style="width:18px;margin-right:5px"> Kirim Hadiah
    </button>
    ...
    <script>
        ...
        function kirim() {
            ...
            let data = `name=${nama.value}&doa=${doa.value}`

            xhr.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    btnDoa.innerHTML = '&#128591; terimakasih atas ucapan dan doanya &#128591;'
                    location.reload();
                    btnDoa.disabled = true;
                }
            };
            xhr.open("POST", "home/add.php", true);
